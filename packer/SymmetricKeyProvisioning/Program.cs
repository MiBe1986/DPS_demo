...
namespace SymmetricKeySample
{
    class Program
    {
        ...
        private static string s_idScope = "INSERT HERE";
        ...
        private const string enrollmentGroupPrimaryKey = "INSERT HERE" ;
        private const string enrollmentGroupSecondaryKey = "INSERT HERE" ; 
	...
	//private static string hostname = Dns.GetHostName();
        private static string registrationId = Dns.GetHostName();
